...
The Java 25 surface reserves `org.progmasoft.visual_xsharp.xmm.writer`,
`org.progmasoft.visual_xsharp.xmm.reader`, and `org.progmasoft.java_utilities.ffi.c` as its canonical public packages.
